...
// Proxy INEGI DENUE (evita CORS; requiere INEGI_DENUE_TOKEN en .env)
Flight::route('GET /api/inegi/buscar', [$inegi, 'buscar']);

// Reporte 1 (PostgreSQL, esquema bd.sql) — entrada: reporte-egresados-por-carrera.php
Flight::route('GET /api/reportes/egresados-por-carrera', [$reporte, 'getEgresadosPorCarrera']);
